...
//
// Modified in 2023 by Chaitanya Kumar <chaitanya.kumar.208@gmail.com>
...
int main(int argc, char *argv[]) {
	...
	std::cerr << "#width,threads,elapsed_seconds\n";
	std::cerr << image_width << ',' << thread_count << ',';
...
#pragma omp parallel for
	...
	auto elapsed_seconds = duration_cast<seconds>(elapsed_time).count();
	// Write image to file
